//Jika ingin jalankan code ini ubah type: "cummmonjs" di package.json
...
describe('Web UI Test', function(){
    ...
    it('should login successfully and sort products from A-Z', async function(){
        ...
        //Klik button sort dan pilih opsi A-Z
        ...
        const productNames = await driver.findElements(By.className('inventory_item_name')); //mengambil semua elemen nama produk yang ada di halaman produk
